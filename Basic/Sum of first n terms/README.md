<h2><a href="https://practice.geeksforgeeks.org/problems/sum-of-first-n-terms5843/1?page=6&difficulty[]=-1&sortBy=submissions">Sum of first n terms</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given and integer N.Calculate&nbsp;the sum of series 1<sup>3</sup> + 2<sup>3</sup> + 3<sup>3</sup> + 4<sup>3</sup> + …&nbsp;till N-th term.</span></p>
